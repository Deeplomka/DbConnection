...
public class TrainFrontEnd {
    ...
    public void createTrainMenu() {
        ...
        try{
            if(controller.getLocomotiveById(locomotiveID).getId() < 1){
                return;
            }
        }
        catch (Exception ex){
            System.out.println("There was no locomotive by current id");
            return;
        }

        System.out.println("Please enter name of train:");
